...
public class RectangularMapTest{
    ...
    public void TestPlace() throws PositionAlreadyOccupiedException {
        ...
        assertEquals("Position (2,2) is already occupied",exception1.getMessage());
        assertEquals("Position (5,8) is already occupied",exception2.getMessage());
    }
    @Test
    public void TestMove() throws PositionAlreadyOccupiedException{
        RectangularMap map = new RectangularMap(5,5, 2);
        Animal animal1 = new Animal();
...
//        assertTrue(animal3.isAt(new Vector2d(4,3)));
    ...
    public void TestIsOccupied() throws PositionAlreadyOccupiedException{
        ...
        RectangularMap map = new RectangularMap(5,5, 3);
